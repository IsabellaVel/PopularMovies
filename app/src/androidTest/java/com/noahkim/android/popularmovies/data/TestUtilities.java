...
public class TestUtilities extends AndroidTestCase {
    ...
    static ContentValues createTestMovieValues() {
        ...
        movieValues.put(MovieEntry._ID, 12);
        movieValues.put(MovieEntry.COLUMN_MOVIE_ID, 10378);
        ...
        movieValues.put(MovieEntry.COLUMN_VOTE_AVERAGE, 6.5);
    ...
    static ContentValues createConflictedMovieValues() {
        ContentValues movieValues = new ContentValues();
        movieValues.put(MovieEntry._ID, 12);
        movieValues.put(MovieEntry.COLUMN_MOVIE_ID, 11954);
        ...
        movieValues.put(MovieEntry.COLUMN_VOTE_AVERAGE, 5.7);
